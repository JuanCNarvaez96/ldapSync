...
$file_name = 'logs.txt';
//crea el log 
echo CrearArchivoLog($file_name)."<br>";
...
if ($jsonSessionArray !== null && isset($jsonSessionArray["session_token"])) 
{
	...
	//echo CompararUsuariosNuevos($jsonUsuariosGlpi, $usuariosLdap, $sessionToken);   

    //5. Valida activacion y desactivacion de usuarios

    $resultadoActualizacion =  CompararUsuariosExistentes($jsonUsuariosGlpi, $usuariosLdap, $sessionToken);  
    ...
    InsertarEntradaLog($file_name, $resultadoActualizacion); 
